...
public class CredentialTab {
    ...
    private WebElement newCredentialButtonField;
    ...
    @FindBy(css = "#credential-update")
    private WebElement editCredentialBtnField;

    @FindBy(css = "#delete-credential")
    private WebElement deleteCredentialButotnField;
    ...
    public void clickNewCredentialBtn(){
        this.javascriptExecutor.executeScript("arguments[0].click();", newCredentialButtonField);
    }
    ...
    public void deleteCredential(){
        this.clickCredentialsTab();
        this.javascriptExecutor.executeScript("arguments[0].click();", deleteCredentialButotnField);
    }
}
